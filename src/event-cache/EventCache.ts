...
import { ApplicationMetadataManager } from '../sessions/ApplicationMetadataManager';
...
export class EventCache {
    ...
    private applicationMetadataManager: ApplicationMetadataManager;
    ...
    constructor(applicationDetails: AppMonitorDetails, config: Config) {
        ...
        this.applicationMetadataManager = new ApplicationMetadataManager(
            config
        );
    }
    ...
    private addRecordToCache = (type: string, eventData: object) => {
        ...
        const metaData: MetaData = {
            ...
            application: {
                ...this.applicationMetadataManager.getAttributes()
            }
        };
